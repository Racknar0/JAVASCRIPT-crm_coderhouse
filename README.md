<h1 align="center">🌟 PROJECT: CRM CODERHOUSE 
🎨</h1>


<h3 align="center">🛠️ CRM Developed for the Coderhouse course
</h3>
...
![GitHub last commit](https://img.shields.io/github/last-commit/Racknar0/JAVASCRIPT-crm_coderhouse)
![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/Racknar0/JAVASCRIPT-crm_coderhouse)
![GitHub language count](https://img.shields.io/github/languages/count/Racknar0/JAVASCRIPT-crm_coderhouse)
![GitHub top language](https://img.shields.io/github/languages/top/Racknar0/JAVASCRIPT-crm_coderhouse)
![GitHub issues](https://img.shields.io/github/issues/Racknar0/JAVASCRIPT-crm_coderhouse)
...
> 📝 This project is a CRM developed with javascript, for course of Coderhouse. The project is a simple CRM, where you can add, edit and delete products, and also add, edit and delete orders. The project is developed with javascript, html and css.
...
> 🌎 [DEPLOY LINK](https://crm-coder.netlify.app/index.html 'DEPLOY LINK')
